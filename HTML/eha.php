        ...
        <div class="wrapper">
            <div class="grid-container" style="border: 2px solid #B22222;">
                ...
                <h2>Start a new analysis</h2>
                    ...
                    <form action="../PHP/upload_email_header.php" method="POST" enctype="multipart/form-data">
                        <div class="row" style="margin-top: 10px; margin-bottom: 20px;">
                            <div class="row">
                                <label for="email_header_file">Upload Email Header File</label>
                            </div>
                            <div class="row">
                                <input type="file" accept=".txt" name="uploaded_email_header_file" id="uploaded_email_header_file" class="form-control" style="margin-top: 2%; color: black;" required>
                            </div>
                        </div>
                        
                        <div class="row">
                            <input type="submit" name="upload" value="Upload Header File">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="grid-container" style="margin-top: 30px; border: 2px solid #B22222;">
                ...
                <h2>Fetch old analysis status</h2>
                    ...
                    <form action="../PHP/fetch_email_header.php" method="POST" enctype="multipart/form-data">
                        <div class="row" style="margin-top: 10px; margin-bottom: 20px;">
                            <div class="row">
                        ...
                        <div class="row">
                            <input type="submit" name="search" value="Fetch Header Analysis Status">
                        </div>
                    </form>
                </div>
            </div>
