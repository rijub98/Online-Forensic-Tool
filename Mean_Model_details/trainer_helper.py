...
from mean_filter import compute_mean_filtered_image_noise_cv2
...
def generate_mean_filtered_dataset(input_dataset, dataset_folder_path, model_folder_path):
    X = []
    Y = []
    ...
    for image_detail in input_dataset:
        ...
        X.append(np.array(compute_mean_filtered_image_noise_cv2(image_file, resize_factor, model_folder_path)).flatten() / 255.0)
